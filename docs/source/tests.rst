...
The job requested a report of the test coverage of the code, but this was not available in the "Community" version of the IDE that was used, JetBrains PyCharm.
